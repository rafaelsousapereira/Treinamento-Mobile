package com.treinamentomobile.api1
...
import com.treinamentomobile.api1.data.repository.PostRepository
import com.treinamentomobile.api1.ui.theme.API1Theme
...
fun PostScreen(repository: PostRepository) {
    ...
    // Ao carregar o componente/tela, realiza a requisição para API
    LaunchedEffect(Unit) {
        ...
        try {
            ...
            println("FALHA AO OBTER AS INFORMAÇÕES")
        }
    }
