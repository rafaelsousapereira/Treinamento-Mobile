...
import com.treinamentomobile.projetosqlite.data.entity.PersonWithAddress
...
interface PersonDao {
    ...
    fun getPersonsAddresses(): Flow<List<PersonWithAddress>>
    ...
    // Email contendo o termo
    // @Query("SELECT * FROM persons WHERE email LIKE '%' || :term || '%'")
    // fun searchByEmail(term: String): Flow<List<Person>>
