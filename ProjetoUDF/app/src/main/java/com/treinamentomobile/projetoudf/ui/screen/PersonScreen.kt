package com.treinamentomobile.projetoudf.ui.screen
...
import com.treinamentomobile.projetoudf.R
import com.treinamentomobile.projetoudf.viewmodel.PersonViewModel
...
fun PersonScreen(viewModel: PersonViewModel = viewModel()) {
    ...
    Column(
        ...
        Text(
            text = "Projeto CRUD de Pessoas - UDF",
        ...
        Row {
            OutlinedTextField(
                ...
                onValueChange = { newValue ->
                    // all -> tranforma o valor em uma cadeia de caracteres
                ...
                Card(
                    ...
                    Row(
                        ...
                        IconButton(
                            onClick = {
                                viewModel.onAction(
                                    PersonViewModel.PersonAction.RemoverPerson(person)
                                )
                            }
                        ) {
                            Icon(
